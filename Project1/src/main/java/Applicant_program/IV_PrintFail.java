...
public class IV_PrintFail extends IV_Menu {

	public void ivPrintFail() {
		...
		try {
			...
			System.out.println("최종 불합격자 명단 출력에 성공하였습니다.");
		} catch (SQLException e) {
			System.out.println("최종 불합격자 명단 출력에 실패하였습니다.");
			//e.printStackTrace();
		} 
