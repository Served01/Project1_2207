...
public class DM_PrintPass extends DM_Menu {

	public void dmPrintPass() {
	...
	try {
		...
		try {
			...
			System.out.println("서류 합격자 명단 출력에 성공하였습니다.");
		} catch (SQLException e) {
			System.out.println("서류 합격자 명단 출력에 실패하였습니다.");
			//e.printStackTrace();
		} 
